...
import { getEntity, deleteEntity } from './to-do.reducer';
...
export const ToDoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rhv7App.toDo.delete.question">Are you sure you want to delete To Do {toDoEntity.id}?</ModalBody>
      <ModalFooter>
