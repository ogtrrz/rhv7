...
export const EvidenceDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(evidenceEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rhv7App.evidence.delete.question">Are you sure you want to delete Evidence {evidenceEntity.id}?</ModalBody>
      <ModalFooter>
...
export default EvidenceDeleteDialog;
